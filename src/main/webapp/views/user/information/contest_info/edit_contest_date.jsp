...
<head>
    ...
    <link href="${basePath}/css/user/contest/edit_date.css" rel="stylesheet">
...
<div class="container">
    <div class="jumbotron">
        ...
        <div class="form-horizontal">
            <form id="contestForm" action="${basePath}/user/information/contest_info/edit_contest_date/submit" method="post" onsubmit="return formValidate(this)">
                ...
                <div class="form-group">
                    <label class="col-lg-2 control-label">竞赛类型</label>
                    <div class="col-lg-4">
