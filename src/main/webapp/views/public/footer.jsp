...
<script src="${basePath}/lib/flat-ui/js/flat-ui.js"></script>
<script src="${basePath}/lib/flat-ui/assets/js/application.js"></script>
<script src="${basePath}/lib/bootbox/bootbox.js"></script>
